...
REM Compilar proceso2 (incluyendo headers de OS)
arm-none-eabi-gcc -c -I ..\OS -mcpu=cortex-a8 -mfpu=neon -mfloat-abi=hard -Wall -Werror -O2 -nostdlib -nostartfiles -ffreestanding proceso2.c -o proceso2.o

REM Link
arm-none-eabi-ld -T memmap.ld startup.o proceso2.o stdio.o string.o uart.o -o proceso2.elf

REM Binario
mkdir bin
arm-none-eabi-objcopy proceso2.elf -O binary bin\proceso2.bin

REM Debug
arm-none-eabi-objdump -D proceso2.elf > proceso2.list
mkdir otros
move proceso2.elf otros\
echo Proceso2 compilado correctamente
pause